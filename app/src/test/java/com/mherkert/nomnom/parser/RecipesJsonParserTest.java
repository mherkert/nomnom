...
public class RecipesJsonParserTest {

    RecipesJsonParser recipesJsonParser;
    ...
    public void setUp() throws Exception {
        recipesJsonParser = new RecipesJsonParser();
    }

    @Test
    public void toDomain() {
        List<Recipe> recipes = recipesJsonParser.toDomain(jsonRecipes);
    ...
    public void toDomainGivenEmpty() {
        List<Recipe> recipes = recipesJsonParser.toDomain("");
        Assert.assertTrue(recipes.isEmpty());
        recipes = recipesJsonParser.toDomain("[]");
        Assert.assertTrue(recipes.isEmpty());
        recipes = recipesJsonParser.toDomain(null);
        Assert.assertTrue(recipes.isEmpty());
    }
    ...
    public void toJson() {
        ...
        String json = recipesJsonParser.toJson(recipes);
        Assert.assertEquals(jsonRecipes, json);
    }

    @Test
    public void toJsonGivenEmpty(){
        String json = recipesJsonParser.toJson(new ArrayList<Recipe>());
